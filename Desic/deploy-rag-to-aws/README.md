...
You need to have an AWS account, and AWS [CLI](https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-configure.html) set up on your machine. You'll also need to have [Bedrock](https://aws.amazon.com/es/bedrock/) enabled on AWS (and granted model access to Claude or whatever you want to use).
